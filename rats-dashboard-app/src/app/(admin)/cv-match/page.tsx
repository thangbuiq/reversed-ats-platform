        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-6 xl:grid-cols-12">
                ...
                <div className="xl:col-span-7">
                    {error && (
                        <div className="rounded-xl border border-error-200 bg-error-50 p-4 text-error-600 dark:border-error-500/30 dark:bg-error-500/10 dark:text-error-400 mb-6">
